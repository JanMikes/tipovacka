...
| 21 | [One match card: migrate `/zapasy`, delete the `variant` prop](items/21-one-match-card.md) | IN PROGRESS | — |
...
|---|---|---|
| [`BUGS.md`](BUGS.md) | Bug / hardening backlog (B1…) — independent of the page restructure | B1–B9, B11, B13–B21, B23, B25 DONE · B10 **WONTFIX** (by design) · B12/B22/B24/B26/B27 TODO |

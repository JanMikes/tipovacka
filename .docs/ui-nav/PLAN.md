...
| 30 | [„Chybí natipovat X zápasů" badge, on both card surfaces](items/30-nastenka-missing-tips-badge.md) | DONE | `9937154` |
| 31 | [A secondary arrow link is a link, not a button](items/31-arrow-links-are-links.md) | DONE | `1061a6b` |
...
| 36 | [The missing-tips badge says „Chybí 3 tipy"](items/36-shorten-the-missing-tips-badge.md) | IN PROGRESS | — |

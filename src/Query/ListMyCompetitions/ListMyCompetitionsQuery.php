    ...
    public function __invoke(ListMyCompetitions $query): array
    {
        ...
        return array_map(
            static fn (Membership $m): CompetitionListItem => new CompetitionListItem(
                ...
                matchSourceId: $m->competition->headlineSource->id,
                matchSourceName: $m->competition->sourcesLabel,
                matchSourceIsCompleted: $m->competition->scheduleIsComplete,
                ownerNickname: $m->competition->owner->displayName,
                isOwner: $m->user->id->equals($m->competition->owner->id),
                joinedAt: $m->joinedAt,
                matchSourceStartAt: $m->competition->headlineSource->startAt,
                matchSourceEndAt: $m->competition->headlineSource->endAt,

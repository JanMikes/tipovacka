 ...
 *
 * The DEADLINE is the only end it moves. Selling early access to a match still
 * waiting for its „tipování otevřeno od" was tried on 2026-07-30 and withdrawn
 * the same day (DOMAIN.md §Tip window): a waiting match is not for sale, so it
 * gets no offer here and no paywall on its card.
 */

 ...
 * for TODAY (Prague). Runs 03:00 Europe/Prague via the host-cron
 * {@see \App\Console\CaptureDailyLeaderboardSnapshotsCommand}; also directly
 * dispatchable. Idempotent (today's rows are upserted).
 */

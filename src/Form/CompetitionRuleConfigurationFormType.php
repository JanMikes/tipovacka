...
/**
 * @extends AbstractType<CompetitionRuleConfigurationFormData>
 */
final class CompetitionRuleConfigurationFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => CompetitionRuleConfigurationFormData::class,
        ]);
    }
}

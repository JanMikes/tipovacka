...
/**
 * @extends AbstractType<MatchSourceRuleConfigurationFormData>
 */
final class MatchSourceRuleConfigurationFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => MatchSourceRuleConfigurationFormData::class,
        ]);
    }
}

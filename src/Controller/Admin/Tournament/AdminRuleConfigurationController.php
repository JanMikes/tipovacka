...
#[Route('/admin/turnaje/{id}/pravidla', name: 'admin_tournament_rule_configuration', requirements: ['id' => Requirement::UUID])]
final class AdminRuleConfigurationController extends AbstractController
{
    ...
    public function __invoke(Request $request, string $id): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_tournament_rule_configuration', [
                'id' => $tournament->id->toRfc4122(),
            ]);
        }

        return $this->render('admin/tournament/rule_configuration.html.twig', [
            'form' => $form,

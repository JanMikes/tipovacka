...
#[Route('/admin/turnaje/vytvorit', name: 'admin_tournament_create')]
final class CreatePublicTournamentController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $envelope = $this->commandBus->dispatch(new CreatePublicTournamentCommand(
                adminId: $admin->id,
                name: $formData->name,
        ...
        return $this->render('admin/tournament/create_public.html.twig', [
            'form' => $form,
        ]);
    }

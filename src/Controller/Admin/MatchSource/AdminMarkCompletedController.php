...
#[Route('/admin/turnaje/{id}/ukoncit', name: 'admin_match_source_complete', requirements: ['id' => Requirement::UUID], methods: ['POST'])]
final class AdminMarkCompletedController extends AbstractController
{
    ...
    public function __invoke(Request $request, string $id): Response
    {
        ...
        if (!$this->isCsrfTokenValid('admin_match_source_complete_'.$matchSource->id->toRfc4122(), (string) $request->request->get('_token', ''))) {

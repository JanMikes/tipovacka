...
final class RevokeInvitationController extends AbstractController
{
    public function __construct(
        private readonly CompetitionInvitationRepository $invitationRepository,
    ...
    public function __invoke(Request $request, string $invitationId): Response
    {
        ...
        $competitionId = $invitation->competition->id->toRfc4122();
        ...
        try {
            ...
            if ($inner instanceof CompetitionInvitationAlreadyAccepted) {

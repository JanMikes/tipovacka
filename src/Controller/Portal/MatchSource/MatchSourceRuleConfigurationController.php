...
#[Route('/portal/turnaje/{id}/pravidla', name: 'portal_match_source_rule_configuration', requirements: ['id' => Requirement::UUID])]
final class MatchSourceRuleConfigurationController extends AbstractController
{
    ...
    public function __invoke(Request $request, string $id): Response
    {
        ...
        return $this->render('portal/match_source/rule_configuration.html.twig', [
            'form' => $form,

...
#[Route('/portal/turnaje/{id}/upravit', name: 'portal_tournament_edit', requirements: ['id' => Requirement::UUID])]
final class UpdateTournamentController extends AbstractController
{
    ...
    public function __invoke(Request $request, string $id): Response
    {
        ...
        return $this->render('portal/tournament/edit.html.twig', [
            'form' => $form,

...
final class CompetitionMatchSelectionEntityTest extends TestCase
{
    public function testStoresCompetitionMatchAndAddedAt(): void
    {
        ...
        $sportMatch = new SportMatch(
            ...
            matchSource: $matchSource,
            homeTeam: new Team(id: Uuid::v7(), sport: $matchSource->sport, matchSource: $matchSource, name: 'A', createdAt: $now),
            awayTeam: new Team(id: Uuid::v7(), sport: $matchSource->sport, matchSource: $matchSource, name: 'B', createdAt: $now),

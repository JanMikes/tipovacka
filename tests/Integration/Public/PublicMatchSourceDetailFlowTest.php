...
final class PublicMatchSourceDetailFlowTest extends WebTestCase
{
    ...
    public function testUserWithPendingRequestSeesPendingLabel(): void
    {
        ...
        /** @var EntityManagerInterface $em */
        $em = $client->getContainer()->get('doctrine.orm.entity_manager');
        // Verified user has a pending join request for PUBLIC_COMPETITION in the fixtures.
    ...
    public function testUnknownMatchSourceReturns404(): void
    {
        $client = static::createClient();

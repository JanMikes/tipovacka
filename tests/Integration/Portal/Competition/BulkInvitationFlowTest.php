...
final class BulkInvitationFlowTest extends WebTestCase
{
    ...
    public function testOwnerCanBulkInviteAndInviteeCompletesRegistration(): void
    {
        ...
        /** @var CompetitionInvitation $alice */
    ...
    public function testNonOwnerMemberGets403ForBulk(): void
    {
        ...
        // Admin is a verified user, but is not owner of the private competition.
        $admin = $em->find(User::class, Uuid::fromString(AppFixtures::ADMIN_ID));
        self::assertNotNull($admin);
        // Admin has ROLE_ADMIN, which passes CompetitionVoter::MANAGE_MEMBERS. Swap to a plain non-owner member.

        // Make SECOND_VERIFIED_USER a member of the VERIFIED_COMPETITION (not the owner).
        $secondUser = $em->find(User::class, Uuid::fromString(AppFixtures::SECOND_VERIFIED_USER_ID));
        $competition = $em->find(\App\Entity\Competition::class, Uuid::fromString(AppFixtures::VERIFIED_COMPETITION_ID));
